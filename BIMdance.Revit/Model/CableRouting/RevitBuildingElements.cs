...
public class RevitBuildingElements
{
    ...
    public RevitBuildingElements(Document document)
    {
        ...
        LevelsCurvesRooms = new Dictionary<ElementId, Dictionary<Line3D, List<Room>>>();
    ...
    public Dictionary<ElementId, Dictionary<Line3D, List<Room>>> LevelsCurvesRooms { get; }
    ...
    {
        var curvesRoomsOfLevel = new Dictionary<Line3D, List<Room>>();
        ...
        foreach (var room in rooms)
        {
            ...
            foreach (var boundarySegments in boundaries)
            {
                foreach (var boundarySegment in boundarySegments)
                {
                    ...
                    var segment = RevitMapper.Map<Curve, Line3D>(curve);
