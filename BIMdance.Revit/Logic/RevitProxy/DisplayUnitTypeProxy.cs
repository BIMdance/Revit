...
namespace BIMdance.Revit.Logic.RevitProxy;

public enum DisplayUnitTypeProxy
{
    ...
    /// <summary>kilogram per cubic meter (kg/mÂ³)</summary>
    DUT_KILOGRAMS_PER_CUBIC_METER = 28, // 0x0000001C
    /// <summary>pound per cubic foot (lb/ftÂ³)</summary>
    DUT_POUNDS_MASS_PER_CUBIC_FOOT = 29, // 0x0000001D
    /// <summary>pound per cubic inch (lb/inÂ³)</summary>
    ...
    /// <summary>kilowatt hour (kW Â· h)</summary>
    ...
    /// <summary>watt per square foot (W/ftÂ²)</summary>
    DUT_WATTS_PER_SQUARE_FOOT = 45, // 0x0000002D
    /// <summary>watt per square meter (W/mÂ²)</summary>
    DUT_WATTS_PER_SQUARE_METER = 46, // 0x0000002E
    /// <summary>inch of water (60.8Â°F)</summary>
    ...
    /// <summary>degree Fahrenheit (ÂºF)</summary>
    DUT_FAHRENHEIT = 56, // 0x00000038
    /// <summary>degree Celsius (ÂºC)</summary>
    DUT_CELSIUS = 57, // 0x00000039
    /// <summary>kelvin (K)</summary>
    DUT_KELVIN = 58, // 0x0000003A
    /// <summary>degree Rankine (ÂºR)</summary>
    ...
    /// <summary>candela per square meter (cd/mÂ²)</summary>
    ...
    /// <summary>horsepower (550 ft Â· lbf/s)</summary>
    ...
    /// <summary>pascal second (Pa Â· s)</summary>
    DUT_PASCAL_SECONDS = 129, // 0x00000081
    /// <summary>pound per foot second (lb/(ft Â· s))</summary>
    ...
    /// <summary>kilnewtons per cubic meter (kN/mÂ³)</summary>
    DUT_KILONEWTONS_PER_CUBIC_METER = 134, // 0x00000086
    /// <summary>pound per cubic foot (kip/ftÂ³)</summary>
    DUT_POUNDS_FORCE_PER_CUBIC_FOOT = 135, // 0x00000087
    /// <summary>pound per cubic foot (kip/inÂ³)</summary>
    ...
    /// <summary>pound per foot hour (lb/(ft Â· h))</summary>
    ...
    /// <summary>watt per square meter kelvin (W/(mÂ² Â· K))</summary>
    DUT_WATTS_PER_SQUARE_METER_KELVIN = 154, // 0x0000009A
    /// <summary>
    ///    British thermal unit[IT] per hour square foot degree Fahrenheit (Btu[IT]/(h Â· ftÂ² Â· ÂºF)
    /// </summary>
    ...
    /// <summary>watt per cubic foot (W/mÂ³)</summary>
    DUT_WATTS_PER_CUBIC_FOOT = 164, // 0x000000A4
    /// <summary>watt per cubic meter (W/mÂ³)</summary>
    DUT_WATTS_PER_CUBIC_METER = 165, // 0x000000A5
    /// <summary>British thermal unit[IT] per hour square foot (Btu[IT]/(h Â· ftÂ²)</summary>
    DUT_BRITISH_THERMAL_UNITS_PER_HOUR_SQUARE_FOOT = 166, // 0x000000A6
    /// <summary>British thermal unit[IT] per hour cubic foot (Btu[IT]/(h Â· ftÂ³)</summary>
    ...
    /// <summary>meters per second squared (m/sÂ²)</summary>
    DUT_METERS_PER_SECOND_SQUARED = 192, // 0x000000C0
    /// <summary>kilometers per second squared (km/sÂ²)</summary>
    DUT_KILOMETERS_PER_SECOND_SQUARED = 193, // 0x000000C1
    /// <summary>inches per second squared (in/sÂ²)</summary>
    DUT_INCHES_PER_SECOND_SQUARED = 194, // 0x000000C2
    /// <summary>feet per second squared (ft/sÂ²)</summary>
    DUT_FEET_PER_SECOND_SQUARED = 195, // 0x000000C3
    /// <summary>miles per second squared (mi/sÂ²)</summary>
    ...
    /// <summary>square feet per foot	(ftÂ²/ft)</summary>
    DUT_SQUARE_FEET_PER_FOOT = 207, // 0x000000CF
    /// <summary>square inches per foot	(inÂ²/ft)</summary>
    DUT_SQUARE_INCHES_PER_FOOT = 208, // 0x000000D0
    /// <summary>square millimeters per meter	(mmÂ²/m)</summary>
    DUT_SQUARE_MILLIMETERS_PER_METER = 209, // 0x000000D1
    /// <summary>square centimeters per meter	(cmÂ²/m)</summary>
    DUT_SQUARE_CENTIMETERS_PER_METER = 210, // 0x000000D2
    /// <summary>square meters per meter	(mÂ²/m)</summary>
    ...
    /// <summary>Grains per hour square foot inch mercury (gr/(hÂ·ftÂ²Â·inHg))</summary>
    ...
    /// <summary>Joules per kilogram Celsius (J/(kgÂ·Â°C))</summary>
    DUT_JOULES_PER_KILOGRAM_CELSIUS = 237, // 0x000000ED
    /// <summary>Micrometers per meter Celsius (um/(mÂ·Â°C))</summary>
    DUT_MICROMETERS_PER_METER_CELSIUS = 238, // 0x000000EE
    /// <summary>Microinches per inch Fahrenheit (uin/(inÂ·Â°F))</summary>
