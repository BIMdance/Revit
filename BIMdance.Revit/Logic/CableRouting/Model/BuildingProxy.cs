...
public class BuildingProxy
{
    ...
    public List<LevelProxy> GetLevels(XYZProxy point1, XYZProxy point2)
    {
    ...
    public RoomProxy GetRoom(LevelProxy level, XYZProxy point)
    {
    ...
    private List<RoomProxy> GetRoomsHorizontal(CableTrayConduitBaseProxy cableTrayConduit)
    {
        ...
        var segment = new SegmentProxy(cableTrayConduit.Point1, cableTrayConduit.Point2);
    ...
    private List<RoomProxy> GetRoomsVertical(CableTrayConduitBaseProxy cableTrayConduit)
    {
        ...
        rooms.AddRange(
            ...
            let point = new XYZProxy(cableTrayConduit.Point1.X, cableTrayConduit.Point1.Y, level.Elevation)
