...
public class RoomProxy : ElementProxy
{
    ...
    public List<List<SegmentProxy>> Segments { get; set; }

    public bool IsPointInRoom(XYZProxy point)
    {
        var intersectionCount = 0;

        foreach (var areaSegments in Segments)
        {
            SegmentProxy previousSegment = null;
    ...
    /// <returns></returns>
    private static Intersection IsIntersectRightRay(XYZProxy rayStartPoint, SegmentProxy segment)
    {
     ...
     *         *---*--- point.Y
     */
    private static bool IsIntersectSegmentPair(XYZProxy point, SegmentProxy segment1, SegmentProxy segment2)
    {
