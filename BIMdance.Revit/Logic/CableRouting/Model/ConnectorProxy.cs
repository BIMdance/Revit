...
public class ConnectorProxy
{
    ...
    public ConnectorProxy(TraceElement element, int id, XYZProxy point) : this(id, point)
    {
        Element = element;
        Element.AddConnector(this);
    }
    public ConnectorProxy(int id, XYZProxy point) : this()
    {
        Id = id;
        Point = point;
    }
